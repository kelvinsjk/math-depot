...
<main class="prose px-2 pt-4 mx-auto dark:text-zinc-100">
  <h1 class="dark:text-goldenrod">Topical Listings</h1>
  ...
  <hr>
  <p class="pb-4">
    Questions from 2013-2020 arranged in topical order following the ordering in
    Shing Lee Publishers 2013-2022 Topical TYS book.
  </p>
</main>
